    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <DetailedContent product={product} personalizedOverview={personalizedOverview} />
            </CardContent>
...
function GeneralContent({ product }: { product: any }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <ul className="space-y-1">
                    {product.ingredients.slice(0, 5).map((ingredient: any, index: number) => (
...
function DetailedContent({ product, personalizedOverview }: { product: any; personalizedOverview: PersonalizedOverview | null }) {
    return (
